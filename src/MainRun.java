...
public class MainRun {
    ...
    public static void DulieuGiangvien(){
        GiangVien gv1=new GiangVien(97,"minh","KhoaiChau","09875554","PGS-TS");
        GIANGVIEN[0]=gv1;
        GiangVien gv2=new GiangVien(98,"truong","Hanoi","09778172","Giang vien chih");
        GIANGVIEN[1]=gv2;
        GiangVien gv3=new GiangVien(99,"duc","hung yen","0332131","Thạc sĩ");
        GIANGVIEN[2]=gv3;
    }

    public static void DulieuMonhoc(){
        MonHoc gv1=new MonHoc(97,"Toán",5,3,1000);
        MONHOC[0]=gv1;
        MonHoc gv2=new MonHoc(98,"Văn",6,4,2000);
        MONHOC[1]=gv2;
    }
